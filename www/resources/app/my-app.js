...
function getPlusInfo() {
    ...
    if (window.device) {
        ...
        localStorage.PUSH_APPID_ID = 'android.app.quiktrak.eu.aislive';
        localStorage.DEVICE_TYPE = "android.app.quiktrak.eu.aislive";
    }
}
...
function loadRechargeCredit() {
    ...
    var CountryCode = getUserinfo().User.CountryCode;

    /*AUS*/
    var buttons = {
        'button10' : 'GAYAKX44K4D9Y',
        'button50' : 'MXPVUCHNGPSXC',
        'button100' : '9TZRDPHXLQEV6',
        'buttonCur' : 'AUD'
    };
    ...
    switch (CountryCode){
        case 'USA':
            buttons.button10  = 'AMZXU82SZ795C';
            buttons.button50  = 'LGPBRHAY673Y6';
            buttons.button100 = 'DH5S8642H6QRJ';
